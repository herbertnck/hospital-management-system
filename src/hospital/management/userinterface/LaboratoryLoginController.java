 ...
 * @author Herbert
 */
public class LaboratoryLoginController implements Initializable {
    @FXML
    private AnchorPane lnpane;
    
    @FXML
    private JFXTextField Labtechname;
    
    @FXML
    private JFXPasswordField Labtechpassword;
    ...
    public void createlogin(ActionEvent event) throws ClassNotFoundException, SQLException, IOException{
      ...
      String str = "SELECT *FROM labtech where FirstName=? and Password=?";
      pst = con.prepareStatement(str);
      
      pst.setString(1, Labtechname.getText());
      pst.setString(2, Labtechpassword.getText());
      ...
      if(count==1)
      {
        ...
        fxmlLoader.setLocation(getClass().getResource("Laboratory.fxml"));
