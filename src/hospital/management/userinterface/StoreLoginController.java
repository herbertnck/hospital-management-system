 ...
 * @author Herbert
 */
public class StoreLoginController implements Initializable {
    @FXML
    private AnchorPane snpane;
    
    @FXML
    private JFXTextField StorekeeperName;
    
    @FXML
    private JFXPasswordField StorekeeperPassword;
...
//      System.out.println(con);
      ...
      String str = "SELECT *FROM storekeeper where FirstName=? and Password=?";
      pst = con.prepareStatement(str);
      
      pst.setString(1, StorekeeperName.getText());
      pst.setString(2, StorekeeperPassword.getText());
