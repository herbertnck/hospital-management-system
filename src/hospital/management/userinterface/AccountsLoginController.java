 ...
 * @author Herbert
 */
public class AccountsLoginController implements Initializable {
    @FXML
    private AnchorPane anpane;
    
    @FXML
    private JFXTextField Accountantname;

    @FXML
    private JFXPasswordField Accountantpassword;
    ...
    public void createlogin(ActionEvent event) throws ClassNotFoundException, SQLException, IOException{
      ...
      String str = "SELECT *FROM accountant where FirstName=? and Password=?";
      pst = con.prepareStatement(str);
      
      pst.setString(1, Accountantname.getText());
      pst.setString(2, Accountantpassword.getText());
      ...
      if(count==1)
      {
        ...
        fxmlLoader.setLocation(getClass().getResource("Accounts.fxml"));
