 ...
 * @author Herbert
 */
public class PatientdiagloginController implements Initializable {
    @FXML
    ...
    @FXML
    private JFXPasswordField Doctorpassword;
    ...
    public void createlogin(ActionEvent event) throws ClassNotFoundException, SQLException, IOException{
      ...
      String str = "SELECT *FROM Doctor where FirstName=? and Password=?";
      pst = con.prepareStatement(str);
      
      pst.setString(1, Doctorname.getText());
      pst.setString(2, Doctorpassword.getText());
      ...
      if(count==1)
      {
        ...
        fxmlLoader.setLocation(getClass().getResource("Patientdiag.fxml"));
